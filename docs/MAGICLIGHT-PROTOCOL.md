...
Full local decoding, measured duration/audio and signed-in playback are required before reporting a playable generation result. Expired source URLs require recovery from the same saved provider task; they must never cause another generation POST.
